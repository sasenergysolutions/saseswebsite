          ...
          <div className="hidden md:flex items-center gap-2">
            ...
            <a
              ...
              className={`inline-flex items-center gap-2 rounded-full px-4 py-2 text-[13px] font-semibold transition-colors ${
                scrolled
                  ? "text-[#0A66C2] border border-blue-200 hover:bg-blue-50"
            ...
            >
              <div className="px-6 py-6 flex flex-col gap-1">
                ...
                <a
                  ...
                  rel="noreferrer"
                  onClick={() => setOpen(false)}
                  className="mt-4 inline-flex items-center justify-center gap-2 rounded-full border border-blue-200 bg-blue-50 px-5 py-3 text-sm font-semibold text-[#0A66C2]"
          ...
          <div className="hidden md:flex items-center gap-2">
            <a
              ...
              className={`inline-flex items-center gap-2 rounded-full px-4 py-2 text-[13px] font-medium transition-colors ${
                scrolled
                  ? "text-slate-700 hover:text-[#0A66C2] hover:bg-slate-50"
                  : "text-white hover:bg              loading="eager"
            />
            <span className="leading-tight hidden sm:block">
