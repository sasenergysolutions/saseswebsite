...
export default function Navbar() {
  ...
  return (
    <>
        ...
        <div className="mx-auto max-w-[1400px] px-6 lg:px-10 flex items-center justify-between h-[72px]">
          ...
          >
            ...
            <span className="leading-tight hidden sm:block">
              <span
                className={`block text-[15px] md:text-base font-bold tracking-tight ${
                  scrolled
                    ? "text-slate-900"
                    : "text-white"
                }`}
              ...
              <span
                className={`block text-[9px] font-medium tracking-[0.22em] uppercase ${
                  scrolled
                    ? "text-[#16A34A]"
                    : "text-[#7CE39E]"
                }`}
              >
                Think Future · Get Benefits
              </span>
            </span>
          </a>
            ...
            {NAV.map((item) => (
              <a
                ...
                className={`text-[13px] font-medium transition-colors duration-200 ${
                  scrolled
                    ? "text-slate-700 hover:text-[#0A66C2]"
                    : "text-white/95 hover:text-[#7CE39E]"
                }`}
          ...
          <div className="hidden lg:flex items-center gap-2">
            <a
              ...
              className={`inline-flex items-center gap-2 rounded-full px-3 py-2 text-[13px] font-medium transition-colors ${
                scrolled
                  ? "text-slate-700 hover:text-[#0A66C2] hover:bg-slate-50"
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className={`inline-flex items-center gap-2 rounded-full border px-4 py-2.5 text-[13px] font-semibold transition-colors ${
                scrolled
            ...
            >
              <div className="px-6 py-6 flex flex-col gap-1">
                ...
                <a
                  ...
                  rel="noreferrer"
                  onClick={() => setOpen(false)}
                  className="mt-4 inline-flex items-center justify-center gap-2 rounded-full border-2 border-[#0A66C2] px-5 py-3 text-sm font-semibold text-[#0A66C2]"
                  data-testid="nav-mobile-admin-login"
                >
                  <LockKeyhole className="h-4 w-4" />
                  Admin Login
                </a>
                ...
                <a
                  href="#contact"
                  onClick={() => setOpen(false)}
                  className="mt-3 inline-flex justify-center rounded-full bg-[#0A66C2] px-5 py-3 text-sm font-semibold text-white"
      ...
      {/* Hero section handles navbar spacing */}
    </>
  );
}
